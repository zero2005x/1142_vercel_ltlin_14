        ...
        <div className='flex justify-between items-center'>
          ...
          <div className='flex gap-x-4'>
            <Button
              ...
              asChild
            >
              <Link href={`/store_14/products_14?layout=grid${search ? `&search=${encodeURIComponent(search)}` : ''}`}>
                <LuLayoutGrid />
              </Link>
            </Button>
            <Button
              ...
              asChild
            >
              <Link href={`/store_14/products_14?layout=list${search ? `&search=${encodeURIComponent(search)}` : ''}`}>
                <LuList />
              </Link>
            </Button>
          </div>
